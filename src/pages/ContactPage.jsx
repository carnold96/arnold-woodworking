    ...
    <div className="min-h-screen">
      ...
      <div className="py-16 text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-white/80 text-lg drop-shadow">Get in touch with me. Or Don't.</p>
        </div>
      </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+15551234567" className="text-amber-400 hover:text-amber-300 transition-colors cursor-pointer">
                    (617) 777-7777 (I think this is a lawyer, great number though)
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    No chance you're getting my address from here<br />
                  </p>
                </div>
              </div>
            </div>
